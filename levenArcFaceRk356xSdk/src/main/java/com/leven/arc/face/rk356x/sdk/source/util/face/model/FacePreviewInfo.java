package com.leven.arc.face.rk356x.sdk.source.util.face.model;
...
public class FacePreviewInfo {
    ...
    //可见光相机预览回传的NV21数据
    private byte[] faceRgbNv21;
    //红外相机预览回传的NV21数据
    private byte[] faceIrNv21;
    ...
    public byte[] getFaceRgbNv21() {
        return faceRgbNv21;
    }

    public void setFaceRgbNv21(byte[] faceRgbNv21) {
        this.faceRgbNv21 = faceRgbNv21;
    }

    public byte[] getFaceIrNv21() {
        return faceIrNv21;
    }

    public void setFaceIrNv21(byte[] faceIrNv21) {
        this.faceIrNv21 = faceIrNv21;
    }
}
