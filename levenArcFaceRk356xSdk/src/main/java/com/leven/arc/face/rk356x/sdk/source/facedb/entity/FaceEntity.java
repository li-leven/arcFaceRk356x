package com.leven.arc.face.rk356x.sdk.source.facedb.entity;
...
public class FaceEntity implements Parcelable {
    ...
    public FaceEntity(String userId, String userName, String imagePath, byte[] featureData) {
        this.userId = userId;
    ...
    @Override
    public int hashCode() {
        int result = Objects.hash(faceId, registerTime, userId, userName, imagePath);
